...
def find_tree(processes: List[EchoElectionProcess], display=False) -> Tree:
    ...
    if display:
        # Display the tree
        display_graph(g, "Tree generated by echo election algorithm")
...
def run_echo_election_algorithm(num_processes: int, num_initiator: int):
    ...
    tree = find_tree(processes, display=True)
    tree.show()
