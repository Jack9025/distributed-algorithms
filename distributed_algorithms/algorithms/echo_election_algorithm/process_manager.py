...
def execute_echo_election_algorithm(processes: List[EchoElectionProcess], msg_manager: MessageManager,
                                    num_initiator: int, execution_num: int = None):
...
def run_echo_election_algorithm(num_processes: int, num_initiator: int, num_executions: int = 1):
    ...
    for i in range(num_executions):
        ...
        execute_echo_election_algorithm(processes, msg_manager, num_initiator, i+1 if num_executions > 1 else None)
